...
/** Lazy view of `sf.substreams.sink.database.v1.DatabaseChanges`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `DatabaseChangesView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `DatabaseChangesView`-family
 ...
 let view = DatabaseChangesLazyView::decode_lazy(&bytes)?;
 ```*/
...
/** Lazy view of `sf.substreams.sink.database.v1.TableChange`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `TableChangeView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `TableChangeView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = TableChangeLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
...
/** Lazy view of `sf.substreams.sink.database.v1.CompositePrimaryKey`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `CompositePrimaryKeyView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `CompositePrimaryKeyView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = CompositePrimaryKeyLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
...
/** Lazy view of `sf.substreams.sink.database.v1.Field`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
